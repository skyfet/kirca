...
///   flutter run --dart-define=KIRCA_API_BASE=https://kirca-api.archen.workers.dev
///   flutter build ios --dart-define=KIRCA_API_BASE=https://kirca-api.archen.workers.dev
///
/// WS-URL получается из `KIRCA_API_BASE` автоматической заменой `http(s)://` → `ws(s)://`.
/// При необходимости можно задать `KIRCA_WS_BASE` явно.
class Config {
  static const String _defaultApiBase = 'https://kirca-api.archen.workers.dev';
